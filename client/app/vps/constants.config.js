...
angular.module("managerApp").constant("constants", {
    EU : {
        ...
        laPageDeThomasSoetesEstDone : false,
        UNIVERS      : "dedicated",
        UNIVERSES : {
            "PORTAL": "PORTAL",
            "WEB": "WEB",
        ...
        TOP_GUIDES : {
            ...
            vps: {
                fr_FR: [
                    {
                        title: "core_vps_top_guide_1_title",
                        atInternetClickTag: "TopGuide-VPS-1",
                        url: "https://www.ovh.com/fr/g1769.creation_des_cles_ssh"
                    }, {
                        title: "core_vps_top_guide_2_title",
                        atInternetClickTag: "TopGuide-VPS-2",
                        url: "https://www.ovh.com/fr/g1862.migration_de_vps_2014_vers_loffre_2016"
                    }, {
                        title: "core_vps_top_guide_3_title",
                        atInternetClickTag: "TopGuide-VPS-3",
                        url: "https://www.ovh.com/fr/g2014.utilisation_de_docker-machine_basee_sur_les_instances_public_cloud"
                    }, {
                        title: "core_vps_top_guide_4_title",
                        atInternetClickTag: "TopGuide-VPS-4",
                        url: "https://www.ovh.com/fr/g1773.creer_un_acces_a_horizon"
                    }, {
                        title: "core_vps_top_guide_5_title",
                        atInternetClickTag: "TopGuide-VPS-5",
                        url: "https://www.ovh.com/fr/g1916.debuter_avec_lapi_swift"
                    }, {
                        title: "core_vps_top_guide_6_title",
                        atInternetClickTag: "TopGuide-VPS-6",
                        url: "https://www.ovh.com/fr/g1851.preparer_lenvironnement_pour_utiliser_lapi_openstack"
                    }, {
                        title: "core_vps_top_guide_7_title",
                        atInternetClickTag: "TopGuide-VPS-7",
                        url: "https://www.ovh.com/fr/g2090.synchroniser_un_nas_synology_avec_lobject_storage_a_laide_de_diskstation_manager_60"
                    }, {
                        title: "core_vps_top_guide_8_title",
                        atInternetClickTag: "TopGuide-VPS-8",
                        url: "https://www.ovh.com/fr/g1785.cloud_dans_linterface_client_OVH"
                    }, {
                        title: "core_vps_top_guide_9_title",
                        atInternetClickTag: "TopGuide-VPS-9",
                        url: "https://www.ovh.com/fr/g1775.creer_une_instance_dans_lespace_client_ovh"
                    }
                ],
                en_GB: [
                    {
                        title: "core_vps_top_guide_1_title",
                        atInternetClickTag: "TopGuide-VPS-1",
                        url: "https://www.ovh.co.uk/g1769.creating_ssh_keys"
                    }, {
                        title: "core_vps_top_guide_2_title",
                        atInternetClickTag: "TopGuide-VPS-2",
                        url: "https://www.ovh.co.uk/g1862.how_to_migrate_from_vps_2014_to_2016"
                    }, {
                        title: "core_vps_top_guide_4_title",
                        atInternetClickTag: "TopGuide-VPS-4",
                        url: "https://www.ovh.co.uk/g1773.configure_user_access_to_horizon"
                    }, {
                        title: "core_vps_top_guide_5_title",
                        atInternetClickTag: "TopGuide-VPS-5",
                        url: "https://www.ovh.co.uk/g1916.getting_started_with_the_Swift_api"
                    }, {
                        title: "core_vps_top_guide_6_title",
                        atInternetClickTag: "TopGuide-VPS-6",
                        url: "https://www.ovh.co.uk/g1851.prepare_the_environment_for_using_the_openstack_api"
                    }, {
                        title: "core_vps_top_guide_7_title",
                        atInternetClickTag: "TopGuide-VPS-7",
                        url: "https://www.ovh.co.uk/g2090.synchronise_synology_nas_with_object_storage_using_diskstation_manager_6_0"
                    }, {
                        title: "core_vps_top_guide_9_title",
                        atInternetClickTag: "TopGuide-VPS-9",
                        url: "https://www.ovh.co.uk/g1775.create_an_instance_in_your_ovh_customer_account"
                    }
                ]
            },
            sd: {
    ...
    US : {
        RENEW_URL : "https://ovh.us/cgi-bin/order/renew.cgi?domainChooser={serviceName}",
        weatherMapUrl : "http://weathermap.ovh.net/",
        loginUrl : "/auth",
        vmsUrl : "http://status.ovh.net/vms/",
        travauxUrl : "http://status.ovh.net/",
        publicCloudUrl : "https://ovh.us/manager/cloud/index.html#/",
        vrackUrl : "https://ovh.us/manager/cloud/index.html#/vrack",
        nashaUrl: "https://ovh.us/manager/cloud/index.html#/paas/nasha",
        laPageDeThomasSoetesEstDone : false,
        UNIVERS      : "dedicated",
        UNIVERSES : {
            "PORTAL": "PORTAL",
        ...
        changelog_url : "engine/2api/changelog/",
        MANAGER_URLS : {
            "dedicated": "https://ovh.us/manager/dedicated/index.html#/",
            //"cloud"     : "https://ovh.us/manager/cloud/index.html#/"
        },
        NO_AUTORENEW_COUNTRIES : [
            "ASIA",
            "AU",
...
// constants.CA.TOP_GUIDES = constants.US.TOP_GUIDES = constants.EU.TOP_GUIDES;
