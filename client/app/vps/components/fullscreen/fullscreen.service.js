angular.module('managerApp').factory('Fullscreen', ['$document', '$rootScope', function ($document,$rootScope) {
    "use strict";

    var document = $document[0],
        // ensure ALLOW_KEYBOARD_INPUT is available and enabled
        isKeyboardAvailbleOnFullScreen = (typeof Element !== 'undefined' && 'ALLOW_KEYBOARD_INPUT' in Element) && Element.ALLOW_KEYBOARD_INPUT,
