class CloudMessage {
    ...
    getMessageHandler (containerName) {
        //  if containerName is not defined, we return messageHandler based on stateName.
    ...
    subscribe (containerName, params) {
        this.subscribers[containerName] = _.extend({
            ...
            flushMessages: () => this.flushMessages(containerName)
        }, params);
        return this.subscribers[containerName];
    }
}
