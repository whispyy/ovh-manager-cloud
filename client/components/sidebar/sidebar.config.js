angular.module("managerApp").config(function (SidebarMenuProvider) {
    ...
    SidebarMenuProvider.addTranslationPath("../components/sidebar");
                 ...
                 MetricsSectionSidebarService, VrackSectionSidebarService, LoadBalancerSidebarService, CloudDbSidebarService,
                 User, Products, FeatureAvailabilityService, REDIRECT_URLS, URLS) {
    "use strict";
